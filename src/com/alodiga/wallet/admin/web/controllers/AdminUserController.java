...
//    }
//
//    private void loadEnterpriseList(List<UserHasProfileHasEnterpriseResponse> userHasProfileHasEnterprises) {
...
//                Listitem item = new Listitem();
//                if (!isAdd) {
//                    List<UserHasProfileHasEnterpriseResponse> uhphes = userParam.getUserHasProfileHasEnterprises();
...
//            List<UserHasProfileHasEnterpriseResponse> uhphes = new ArrayList<UserHasProfileHasEnterpriseResponse>();
//            Profile profile = (Profile) cmbProfiles.getSelectedItem().getValue();
//            for (int i = 0; i < lbxEnterprises.getSelectedCount(); i++) {
//                UserHasProfileHasEnterpriseResponse uhphe = new UserHasProfileHasEnterpriseResponse();
//                uhphe.setUser(user);
...
//                }
//                List<UserHasProfileHasEnterpriseResponse> auxUhphes = new ArrayList<UserHasProfileHasEnterpriseResponse>();
//                List<UserHasProfileHasEnterpriseResponse> activeUhphes = new ArrayList<UserHasProfileHasEnterpriseResponse>();
